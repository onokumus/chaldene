...
var Pluggin = {
  ...
  quill: function(element) {
    if (window.Quill !== undefined) {
      var attrData = $.extend({}, $(element).data());
      var theme = attrData.theme !== undefined
        ? attrData.theme
        : 'snow';
  ...
  perfectscrollbar: function(element) {
